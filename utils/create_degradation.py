# -----------------------------------------------------------------------------
# Code Source and License Compliance
# -----------------------------------------------------------------------------
# This file, or parts of it, contains code derived from the following project:
# 
# Source Repository: https://github.com/ohayonguy/PMRF
# Original File:     https://github.com/ohayonguy/PMRF/blob/main/utils/create_degradation.py
# 
# Original Copyright Notice:
# Copyright (c) 2025 Guy Ohayon
# ---------------------------------------------------------------
...
def create_degradation(degradation):
    if degradation == 'sr_bicubic_x8_gaussian_noise_005':
        ...
        return Compose([
            lambda x: torch.mean(x, dim=0, keepdim=True).repeat(3, 1, 1), # torch.mean(x, dim=0, keepdim=True).repeat(3, 1, 1)
