...
'''
LUNet Adapter
Converting raw time steps into embeddings, as the original ELIR (LUNet) expects t_emb as input.
'''

class LUnetAdapter(nn.Module):
    def __init__(self, **kwargs):
        super().__init__()
        self.model = LUnet(**kwargs)
        self.t_emb_dim = self.model.t_emb_dim

    def forward(self, t, x, y=None):
        t_emb = pos_emb(t, self.t_emb_dim)
