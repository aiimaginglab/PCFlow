...
PRETRAINED_MSE_EXP="BS128_BF16_NF128_ffhq_lunet_taesd_denoising_adm_ema_sigma_0_05_cond_finetune_consistency_0_to_1"
...
task=denoising # sr, inpainting, colorization, denoising
